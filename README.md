...
| 指标 | v1 (14B/460条) | v2 (14B/540条) | v3 (32B) | v4 (32B lr↓alpha↓) | v5 (32B lr↓↓) |
|---|---|---|---|---|---|
| 完美匹配 ✅ | 7/20 (35%) | **9/20 (45%)** | 4/20 (20%) | 5/20 (25%) | 1/20 (5%) |
| 宽松匹配 ✅🟡 | 9/20 (45%) | **11/20 (55%)** | 8/20 (40%) | 10/20 (50%) | 4/20 (20%) |
| 单指标 | 4/5 | 4/5 | 1/5 | 2/5 | 1/5 |
| 边界判断 | 0/3 | 0/3 | 0/3 (🟡1) | 0/3 (🟡1) | 0/3 |
| JSON 合法率 | 20/20 | 20/20 | 20/20 | 20/20 | 20/20 |
| 空输出判断 | 2/2 | 2/2 | 2/2 | 2/2 | 0/2 |
| 类型准确率 | - | - | 100% | 91% | 52% |
| 预测总数/期望 | - | - | 44/32 | 42/32 | 70/32 |

**结论：** 32B 路线确认失败。三轮实验（v3/v4/v5）证明 540 条数据约束不住 32B——lr 高了它不听，lr 低了等于没训。v4 是 32B 天花板（10/20）仍不如 14B v2（11/20）。下一步：回到 14B，用 C.C. 改造后的 Type B 数据（逐项排除式 analysis）重训，测试"教判断逻辑"而非"加数据量"的效果。
