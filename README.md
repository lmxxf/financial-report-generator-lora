...
| 指标 | v1 (14B/460条) | v2 (14B/540条) | v3 (32B/540条) |
|---|---|---|---|
| 完美匹配 ✅ | 7/20 (35%) | **9/20 (45%)** | 4/20 (20%) |
| 宽松匹配 ✅🟡 | 9/20 (45%) | **11/20 (55%)** | 8/20 (40%) |
| 单指标 | 4/5 | 4/5 | 1/5 |
| 边界判断 | 0/3 | 0/3 | 0/3 (🟡1) |
| JSON 合法率 | 20/20 | 20/20 | 20/20 |
| 空输出判断 | 2/2 | 2/2 | 2/2 |
| 类型准确率 | - | - | 100% |
| 预测总数/期望 | - | - | 44/32 |

**结论：** 更大的模型不等于更好的 LoRA 效果。32B 基座能力更强但更难被少量数据约束，导致反而退步。14B + 540 条（v2）目前是最优组合。32B 需要调整 LoRA 超参（降 lr/alpha）才能发挥优势。
