...
| 指标 | v1 (14B/460条) | v2 (14B/540条) | v3 (32B) | v4 (32B lr↓alpha↓) |
|---|---|---|---|---|
| 完美匹配 ✅ | 7/20 (35%) | **9/20 (45%)** | 4/20 (20%) | 5/20 (25%) |
| 宽松匹配 ✅🟡 | 9/20 (45%) | **11/20 (55%)** | 8/20 (40%) | 10/20 (50%) |
| 单指标 | 4/5 | 4/5 | 1/5 | 2/5 |
| 边界判断 | 0/3 | 0/3 | 0/3 (🟡1) | 0/3 (🟡1) |
| JSON 合法率 | 20/20 | 20/20 | 20/20 | 20/20 |
| 空输出判断 | 2/2 | 2/2 | 2/2 | 2/2 |
| 类型准确率 | - | - | 100% | 91% |
| 预测总数/期望 | - | - | 44/32 | 42/32 |

**结论：** 32B 降 lr/alpha 方向正确（v3→v4 从 40%→50%），但仍不如 14B v2（55%）。32B 基座太强，540 条数据约束不住——它倾向于用自己的理解重命名指标、多提辅助指标。继续调参中。
