...
| 指标 | v1 (14B/460) | v2 (14B/540) | v3 (32B) | v4 (32B lr↓) | v5 (32B lr↓↓) | v6 (14B/新TypeB) | v7 (14B/590/50测试) | **v8 (14B/8epochs)** |
|---|---|---|---|---|---|---|---|---|
| 完美匹配 ✅ | 7/20 (35%) | 9/20 (45%) | 4/20 (20%) | 5/20 (25%) | 1/20 (5%) | 8/20 (40%) | 16/50 (32%) | 15/50 (30%) |
| 宽松匹配 ✅🟡 | 9/20 (45%) | 11/20 (55%) | 8/20 (40%) | 10/20 (50%) | 4/20 (20%) | 13/20 (65%) | **24/50 (48%)** | **24/50 (48%)** |
| 单指标 | 4/5 | 4/5 | 1/5 | 2/5 | 1/5 | 5/5 | 9/10 (90%) | 8/10 (80%) |
| 边界判断 | 0/3 | 0/3 | 0/3 (🟡1) | 0/3 (🟡1) | 0/3 | 0/3 (🟡1) | 0/13 (🟡2) | 0/13 (🟡2) |
| JSON 合法率 | 20/20 | 20/20 | 20/20 | 20/20 | 20/20 | 20/20 | 50/50 | 50/50 |
| 空输出判断 | 2/2 | 2/2 | 2/2 | 2/2 | 0/2 | 2/2 | **5/5** | **5/5** |
| 类型准确率 | 95% | 100% | 100% | 91% | 52% | 100% | 98% | 98% |
| 预测总数/期望 | 39/32 | 40/32 | 44/32 | 42/32 | 70/32 | 39/32 | 106/72 | 106/72 |

*注：v1-v6 使用 20 条测试集，v7-v8 扩充至 50 条测试集，百分比不直接可比。*
...
3. **590 条数据 5 epochs 已饱和。** v8（8 epochs）与 v7（5 epochs）结果完全相同（48%），多训 3 轮只是过拟合噪音
4. **已解决的场景：** 单指标（90%）、空输出（100%）、混合类型（80%）
5. **未解决的场景：** 边界判断（0/13 严格）、多指标（2/10）——14B 模型在"克制"和"精确数量控制"上有天花板
